...
namespace System.Compiler{
  ...
  public class BinaryExpression : Expression{
    ...
    //HS D
    public class LambdaHole : BinaryExpression {
        public LambdaHole(Expression operand1, Expression operand2, NodeType nodeType, SourceContext ctx)
        : base(operand1, operand2, nodeType, ctx) { 
        }
    }
